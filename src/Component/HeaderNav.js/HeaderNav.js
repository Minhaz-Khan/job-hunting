    ...
    return (
        <nav className={isOpen || "relative bg-white shadow dark:bg-gray-800"}>
            <div className="container px-6 py-4 mx-auto md:flex md:justify-between md:z-30 md:items-center">
                ...
                <div className={`${isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full '}absolute inset-x-0  w-full px-6 py-4 transition-all duration-500 ease-in-out bg-white dark:bg-gray-800 md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center `}>
